namespace HwProj.Migrations
{
    ...
    public partial class init : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                "dbo.PullRequestsData",
                c => new
                    {
                        Id = c.Long(nullable: false, identity: true),
                        RepositoryName = c.String(),
                        PullRequestNumber = c.Int(nullable: false),
                        HomeworkId = c.Long(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.StudentsHomework", t => t.HomeworkId, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.PullRequestsData", "HomeworkId", "dbo.StudentsHomework");
            ...
            DropIndex("dbo.PullRequestsData", new[] { "HomeworkId" });
            ...
            DropTable("dbo.PullRequestsData");
